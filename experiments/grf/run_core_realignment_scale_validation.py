...
def main() -> None:
    ...
    assert store.placement_count() == 10_000
    assert len(store.at(CellAddress("eisenstein_exact_v1", "chart:scale", 0, 9999, -9999))) == 1
    print("core realignment scale validation passed: 10000 direct cell operations")
