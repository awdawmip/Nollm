...
- GKC1: Finite Directed-Kernel Composition / Non-Identity Synthetic Validation is implemented as a pure geometry validation asset composing existing DG1 coverage directions; final acceptance pending.
