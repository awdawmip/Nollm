...
- GKD1: Finite Bidirectional Coverage-Kernel / Directional Non-Inversion Synthetic Validation is implemented as a pure geometry validation asset comparing existing DG1 coverage directions; final acceptance pending.
