...
- GPR1: Geometry Profile / Parameter-Regime Synthetic Validation is implemented from DX2 sealed baseline and pending independent acceptance. GPR1-C1 multilayer coverage diagnostic closure is implemented and final acceptance pending; it samples each legal base layer in the finite 0..16 window for coverage metrics without selecting a new production profile or modifying sealed production geometry.
