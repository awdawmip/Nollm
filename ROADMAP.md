...
- DF1: Finite Field Snapshot Assembly adds a read-only, in-memory assembly layer for explicit host-supplied finite AdmissionRecord sets. It replays DA1 records, validates DE1/DC1/DG1/DG2 bindings, derives immutable FiniteFieldSnapshot values, and exposes a DR1-compatible RecallUniverse view without discovery, persistence, Query, recall execution, runtime, OpenClaw, database, cache, LLM/NLP, embeddings, or anchors.
