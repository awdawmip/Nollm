...
- GPR1: Geometry Profile / Parameter-Regime Synthetic Validation is implemented from DX2 sealed baseline and pending independent acceptance. It reports finite DG1 parameter-matrix diagnostics for A-E, including B as the current engineering baseline, without selecting a new production profile or modifying sealed production geometry.
