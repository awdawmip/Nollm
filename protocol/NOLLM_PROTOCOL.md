...
- Card: A Markdown memory unit with front matter and body.
- Anchor: A named coordinate used to orient recall.
...
- Memory address: A deterministic coordinate for locating a memory.
...
Cortex decides how an LLM should orient itself against Core. It may propose anchors, read cards, produce digests, and recommend writes, but its conclusions are not Core truth until recorded as auditable Core objects.
