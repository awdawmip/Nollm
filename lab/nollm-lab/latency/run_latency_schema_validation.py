...
def main() -> None:
    records = [
        {"schema_version": COMMIT_SCHEMA, "event_type": "formation_completed", "event_epoch_ms": 1000, "scenario_id": "W_NEW_SINGLE", "validation_run_id": "fixture", "turn_correlation_id": "t1", "formation_statement_count": 1, "formation_provider_total_ms": 10, "formation_local_total_ms": 1},
        {"schema_version": COMMIT_SCHEMA, "event_type": "placement_terminal", "event_epoch_ms": 1020, "scenario_id": "W_NEW_SINGLE", "validation_run_id": "fixture", "turn_correlation_id": "t1", "statement_index": 0, "final_outcome": "applied", "turn_to_statement_durable_ms": 20},
