...
from nollm.grf.stitching import StitchProposal, StitchWitness
...
def test_false_friend_lexical_hint_is_preserved_as_rejected_anti_stitch() -> None:
    ...
    proposal = StitchProposal("proposal_ab", "patch_a", "patch_b", (("dq", 0),), (lexical,), Q16_ONE // 2, "proposed")
...
def test_company_fixture_can_accept_with_source_backed_or_manual_witness() -> None:
    ...
    proposal = StitchProposal("proposal_ac", "patch_a", "patch_c", (("dq", 1),), (source,), Q16_ONE, "proposed")
