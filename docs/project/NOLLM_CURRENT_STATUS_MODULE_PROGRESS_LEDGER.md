...
| LAB | 50% | 55% | 55% | `IMPLEMENTED` | high | 562 assets classified; all 132 gated assets covered; contract/import errors 0 | corpus and long stress runs |
| DISTRIBUTIONS | 40% | 45% | 45% | `IMPLEMENTED` | high | canonical manifest carries asset class and gate truth; unclassified 0 | installer and version negotiation |
...
The current taxonomy evidence supports the expected vector with zero measured
module deviation. The validated code remains commit
